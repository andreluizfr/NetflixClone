    ...
    useEffect(()=>{
        ...
        if(video.current){
            if(import.meta.env.DEV) {
                player.initialize(video.current, "tracks/1/manifest.mpd", true, 0);
            }
            else {
                player.initialize(video.current, "https://netflix-clone-2.s3.sa-east-1.amazonaws.com/tracks/id-teste-1/manifest.mpd", true, 0);
            }
        ...
        >
            <div className="dash-video-player ">
                <div className="videoContainer" ref={videoContainer} id="videoContainer">
                    ...
                    <div id="videoController" ref={videoController} className="video-controller unselectable">
                        ...
                        <div id="captionBtn" ref={captionBtn} className="btn-caption control-icon-layout" title="Closed Caption">
                            <span className="icon-caption"></span>
                        </div>

                        <div id="fullscreenBtn" ref={fullscreenBtn} onClick={()=>onFullscreenClick()} className="btn-fullscreen control-icon-layout" title="Fullscreen">
                    ...
                    <div id="loading" className='icon-loading' ref={iconLoading}>
