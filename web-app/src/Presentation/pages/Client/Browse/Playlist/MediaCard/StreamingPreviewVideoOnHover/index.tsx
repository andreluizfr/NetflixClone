...
export default function StreamingPreviewVideoOnHover ({trackMetadata, media}: props) {
    ...
    useEffect(()=>{
        if(video.current){
            video.current.poster = media.thumbnailUrl;
