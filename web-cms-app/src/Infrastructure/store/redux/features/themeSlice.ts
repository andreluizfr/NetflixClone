...
const themeSlice = createSlice({
    name: 'theme',
    initialState: {
        selectedTheme: persistentStorage.get<string>("selectedTheme")?
            persistentStorage.get<string>("selectedTheme") : "light",
    ...
    reducers: {
        selectTheme(state: ThemeState, action: ReduxAction<string>) {
            if(action.payload){
