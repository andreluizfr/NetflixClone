...
import com.example.UserService.User.Business.UserBusiness;
...
public class UserController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<Object> fetchUser(@RequestHeader("X-Logged-In-User") String userId) 
            throws FailToFindUserException {

        User user = userBusiness.fetchUser(UUID.fromString(userId));
