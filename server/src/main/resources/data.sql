...
-- criando usuários
-- basic = 0, admin = 1
INSERT INTO account (id, is_active, payment_history, profiles, created_at)
...
INSERT INTO account (id, is_active, current_plan, plan_expire_date, payment_history, profiles, limit_of_profiles, created_at)
