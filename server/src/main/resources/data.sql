-- filmes
-- 6 = romance
INSERT INTO media (media_id, title, is_animation, genres, director, release_year, descriptions, age_rating, thumbnail_url, poster_url, trailer_url, created_at)
...
INSERT INTO episode (id, episode_url, duration, created_at)
VALUES ('00000000-0000-0000-0000-000000000000', 'https://www.youtube.com/watch?v=us7zUFtoc9Q', 100, '2023-08-02 13:14:21.045328');
INSERT INTO episode (id, episode_url, duration, created_at)
VALUES ('00000000-0000-0000-0000-000000000001', 'https://www.youtube.com/watch?v=FDcsfr7bsE8', 100, '2023-08-02 13:14:21.045328');
INSERT INTO episode (id, episode_url, duration, created_at)
VALUES ('00000000-0000-0000-0000-000000000002', 'https://www.youtube.com/watch?v=7ZzP1vgk5nA', 100, '2023-08-02 13:14:21.045328');
...
INSERT INTO episode (id, anime_id, title, thumbnail_url, episode_url, duration, ordem, created_at)
...
--Criando listas
INSERT INTO media_list (id, title, created_at)
VALUES('5ced3b53-8d57-447d-aa69-fd0a55ab85d8', 'teste 1', '2023-08-02 13:14:22.045328');
INSERT INTO media_list (id, title, created_at)
VALUES('0316dfc4-912d-4cda-9018-419bb3045cd1', 'teste 2', '2023-08-02 13:14:23.045328');
INSERT INTO media_list (id, title, created_at)
VALUES('ac3cdec1-3994-4ee6-8b15-0b3b72793695', 'teste 3', '2023-08-02 13:14:24.045328');
INSERT INTO media_list (id, title, created_at)
VALUES('6d3bc137-ce46-43ac-9460-287d096192df', 'teste 4', '2023-08-02 13:14:25.045328');
INSERT INTO media_list (id, title, created_at)
VALUES('53c24404-5136-4568-84a8-1a0f543f177b', 'teste 5', '2023-08-02 13:14:26.045328');
...
-- basic = 0, admin = 1
INSERT INTO account (id, is_active, payment_history, created_at)
VALUES ('48c3684d-3093-4e99-8ac6-8dbc6a902cce', FALSE, '[]', '2023-08-02 13:14:21.045328');
INSERT INTO user_info (id, email, password, birth_date, role, account_id, created_at) --teste123
VALUES ('561718d0-1c7c-4251-97c0-946f1048243b', 'teste@teste.com', '$2a$12$Ju2OKxxKmeE2A36X885fR.DUuQutAQmvLOcZgo6Xh7fGCJwyDN8LW', '2004-10-19', 0, '48c3684d-3093-4e99-8ac6-8dbc6a902cce', '2004-10-19T10:24:01-03:00');

--conta admin
INSERT INTO account (id, is_active, current_plan, plan_expire_date, payment_history, limit_of_profiles, created_at)
VALUES ('dbca60d0-2f7d-497d-8964-66fe2f62a179', TRUE, 2, '2030-08-02 13:14:21.045328', '[]', 5, '2023-08-02 13:14:21.045328');
INSERT INTO user_info (id, email, password, birth_date, role, account_id, created_at) --admin123
VALUES ('385a5f10-694e-430c-853f-5fcdc13b5f17', 'andre@admin.com', '$2a$12$ZyygM5Xn77wOwoooLyaSA.b1O9DttZSLHNp6VGsxB2NbGhXHozlLi', '1999-07-22', 1, 'dbca60d0-2f7d-497d-8964-66fe2f62a179', '2023-08-02 13:14:21.045328');
--perfil da conta
INSERT INTO profile (id, account_id, owner_name, icon_cod, preferences, created_at)
VALUES ('acb9948a-1735-4bd5-a2e8-0e8adedae018', 'dbca60d0-2f7d-497d-8964-66fe2f62a179', 'andre adm', 1, '{}',  '2023-08-03 15:00:21.045328');
...
VALUES (1, 3, '2023-08-02 13:14:21.045328');