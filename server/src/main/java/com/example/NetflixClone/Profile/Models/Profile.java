package com.example.NetflixClone.Profile.Models;
...
import com.example.NetflixClone.Profile.Models.Records.ProfilePreferences;
...
public class Profile {
    ...
    @JoinTable(name = "profile_and_seen_medias", joinColumns = @JoinColumn(name = "profile_id"), inverseJoinColumns = @JoinColumn(name = "media_id"))
