package com.example.NetflixClone.Payment.Business;
...
public class PaymentBusiness {
    ...
    @Transactional
    public Preference createPlanPayment(CreatePlanPaymentDTO data) throws FailToCreatePlanPaymentException,
